                ...
                <div class="card-body">
                    <div class="d-flex justify-content-center py-1">
                        <form method="post" class="my-3">
                            <input type="hidden" name="sl" value="<?php echo $student['SL']; ?>">
                            <span class="d-flex">
                                <div>
                                    <label for="name">Name</label><br>
                                    <input type="text" id="name" name="name" value="<?php echo $student['Name']; ?>"
                                        required class="my-1 py-2 px-2 me-5">
                                </div>

                                <div>
                                    <label for="phone">Phone</label><br>
                                    <input type="text" id="phone" name="phone" value="<?php echo $student['Phone']; ?>"
                                        required class="my-1 py-2 px-2"><br>
                                </div>
                            </span>


                            <label for="address" class="mt-3">Address</label>
                            <input id="address" name="address" required value="<?php echo $student['Address']; ?>"
                                class="my-2 py-2 px-2 w-100"><br>

                            <button type="submit"
                                class="bg-primary text-white text-center text-decoration-none border-0 rounded-1 my-2 px-2 py-2">Update
                                Student</button>
                        </form>
                    </div>
                </div>
